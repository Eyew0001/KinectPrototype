        ...
        for (var i = 0; i < bodyFrame.bodies.length; i++) {
            ...
            if (bodyFrame.bodies[i].tracked == true) {
                ...
                for (var j = 0; j < jointNums.length; j++) {
                    ...
                    if (i < 2) {
                        particleDraw(joint.depthX, joint.depthY, colourArray[0*3], colourArray[(0*3) + 1], colourArray[(0*3) + 2]);
                        // console.log("colour " + colourArray[index*3]);

                    } else if (i > 1 && i < 4) {


                        drawLine(joint.depthX, joint.depthY, colourArray[0*3], colourArray[(0*3) + 1], colourArray[(0*3) + 2]);
                        // console.log(jointsCombo[j][0][0]);
                    } else {
                        strokeDraw(joint.depthX, joint.depthY, colourArray[0*3], colourArray[(0*3) + 1], colourArray[(0*3) + 2]);
